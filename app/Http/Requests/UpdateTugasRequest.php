...
class UpdateTugasRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $tugasId = $param instanceof \App\Models\TugasHeader ? $param->id
                  : (is_scalar($param) ? (int) $param : null);
    ...
    protected function prepareForValidation(): void
    {
        ...
        // Pastikan ID utama selalu terisi (fallback dari field tanpa _id jika ada)
        $this->merge([
        ...
        // Duplikasi untuk kompatibilitas dengan service/model yang membaca key tanpa _id.
        // Nilainya tetap ID (integer), BUKAN label teks.
        $this->merge([
        ...
        // Tembusan: normalize ke baris-baris unik
