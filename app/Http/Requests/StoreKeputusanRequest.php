...
class StoreKeputusanRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        // ✅ FIXED: Trim and sanitize menimbang/mengingat
        ...
        // Diktum - No sanitization needed for HTML content (will be purified in service/model)
        ...
        // ✅ FIXED: Validate and sanitize internal recipients
