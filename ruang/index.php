...
<head>
  ...
  <title>Jadwal Ruangan FIKOM - Sistem Booking</title>
  ...
  <style>
    ...
    .fc-timegrid-slot-lane.fc-non-business {
      background-color: #fff;
    }
...
<body>
  ...
  <div class="container">
    <div class="date-selector" style="text-align: center;">
      ...
      <p style="margin-top: 1rem; color: #666; font-size: 0.9rem;">
        Jadwal gabungan mata kuliah dan peminjaman oleh mahasiswa/dosen.<br>
        Silakan <a href="login.php">login</a> untuk mengajukan peminjaman.
      </p>
    ...
    <div id="calendar-container">
      ...
      <div class="legend-calendar">
        ...
        <div class="legend-item">
          <div class="legend-color" style="background: #3788d8;"></div> <span>Mata Kuliah Tetap</span>
        </div>
        <div class="legend-item">
          <div class="legend-color" style="background: #4CAF50;"></div> <span>Peminjaman (Disetujui)</span>
        </div>
        <div class="legend-item">
          <div class="legend-color" style="background: #ff9f0a;"></div> <span>Peminjaman (Pending)</span>
        </div>
      </div>
    </div>
  ...
  <footer class="footer">
    <p>&copy; 2024 Sentralisasi Ruangan FIKOM - Fakultas Ilmu Komputer</p>
  </footer>
