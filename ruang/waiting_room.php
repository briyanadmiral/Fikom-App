...
// Jika status bukan pending, kembalikan ke index.php
...
<head>
    ...
    <title>Waiting Room - Sentralisasi Ruangan FIKOM</title>
...
<body>
    <div class="waiting-wrapper">
        ...
        <h2>Akses Menunggu Verifikasi</h2>
        <p>Akun mahasiswa Anda telah berhasil diregistrasi di sistem Peminjaman Ruangan FIKOM. Mohon tunggu beberapa saat hingga Admin Ruangan memverifikasi dan menyetujui akun Anda.</p>
