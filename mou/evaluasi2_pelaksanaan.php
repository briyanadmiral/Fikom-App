...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: evaluasi2_pelaksanaan.php?id=$id_pelaksanaan");
    exit;
}
...
$evaluasi_tersimpan = mysqli_query($conn, "
    ...
    JOIN keterangan_evaluasi ke ON ee.id_ket_evaluasi = ke.id_ket_evaluasi
    WHERE ee.id_pelaksanaan = $id_pelaksanaan
");
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Evaluasi Eksternal</title>
    ...
    <div class="row min-vh-100">
        ...
        <main class="col-md-10 ms-sm-auto px-md-4">
            <div class="pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Evaluasi Eksternal</h1>
                <p class="text-muted mb-0">Kegiatan: <?= htmlspecialchars($kegiatan['nama_pelaksanaan'] ?? 'Tidak Ditemukan') ?></p>
            </div>
