...
<head>
    ...
    <title>Hasil Kuesioner Kepuasan - FIKOM APP</title>
...
<body>
        ...
        <div class="row min-vh-100">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 py-4">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Hasil Kuesioner Kepuasan Kerja Sama</h1>
                </div>
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    <p class="text-muted mb-0">Halaman visualisasi hasil feedback kuesioner dari mitra eksternal FIKOM UNIKA.
                        Klik opsi jawaban di bawah untuk melihat siapa saja pengisi kuesioner tersebut.</p>
                    <a href="evaluasi_kepuasan.php" class="btn btn-custom-action btn-sm">
                ...
                <div class="card glass-panel border-0 p-4 mb-4">
                    <div class="row g-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 mb-3">
                                    <h6 class="fw-bold text-dark mb-3" style="font-size: 0.95rem;">
                                        1. Bagaimana penilaian Bapak/Ibu secara keseluruhan terhadap jalannya program kerja sama
                                        yang telah dilakukan bersama Fakultas kami?
                                    </h6>
                                    <div class="p-3 rounded bg-white bg-opacity-50 border border-white">
                                        ...
                                        ?>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q1', 'sangat_puas', 'Pertanyaan 1 - Sangat Puas')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Sangat Puas <i class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q1_sangat_puas ?> (<?= $pct_q1_sp ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    style="width: <?= $pct_q1_sp ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q1', 'puas', 'Pertanyaan 1 - Puas')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Puas <i class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q1_puas ?> (<?= $pct_q1_p ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-primary" role="progressbar"
                                                    style="width: <?= $pct_q1_p ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q1', 'cukup_puas', 'Pertanyaan 1 - Cukup Puas')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Cukup Puas <i class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q1_cukup_puas ?> (<?= $pct_q1_cp ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-warning" role="progressbar"
                                                    style="width: <?= $pct_q1_cp ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger" style="margin-bottom:0;"
                                            onclick="showRespondents('q1', 'kurang_puas', 'Pertanyaan 1 - Kurang Puas')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Kurang Puas <i class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q1_kurang_puas ?> (<?= $pct_q1_kp ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                                    style="width: <?= $pct_q1_kp ?>%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    <h6 class="fw-bold text-dark mb-3" style="font-size: 0.95rem;">
                                        2. Bagaimana penilaian Bapak/Ibu mengenai aspek komunikasi, responsivitas, dan pelayanan
                                        administrasi dari pihak Fakultas selama proses kerja sama berlangsung?
                                    </h6>
                                    <div class="p-3 rounded bg-white bg-opacity-50 border border-white">
                                        <?php
                                        ...
                                        ?>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q2', 'sangat_baik', 'Pertanyaan 2 - Sangat Baik')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Sangat Baik (Cepat, tanggap, dan komunikatif) <i
                                                        class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q2_sangat_baik ?> (<?= $pct_q2_sb ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    style="width: <?= $pct_q2_sb ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q2', 'baik', 'Pertanyaan 2 - Baik')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Baik (Responsif dan lancar) <i class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q2_baik ?> (<?= $pct_q2_b ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-primary" role="progressbar"
                                                    style="width: <?= $pct_q2_b ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q2', 'cukup', 'Pertanyaan 2 - Cukup')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Cukup (Standar namun ada beberapa kendala minor) <i
                                                        class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                            ...
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-warning" role="progressbar"
                                                    style="width: <?= $pct_q2_c ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger" style="margin-bottom:0;"
                                            onclick="showRespondents('q2', 'kurang', 'Pertanyaan 2 - Kurang')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Kurang (Lambat merespons atau koordinasi kurang jelas) <i
                                                        class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                ...
                                <div class="col-12">
                                    <h6 class="fw-bold text-dark mb-3" style="font-size: 0.95rem;">
                                        3. Apakah program kerja sama yang telah dijalankan memberikan dampak positif atau nilai
                                        tambah yang nyata bagi instansi/perusahaan Bapak/Ibu?
                                    </h6>
                                    <div class="p-3 rounded bg-white bg-opacity-50 border border-white">
                                        <?php
                                        ...
                                        ?>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q3', 'signifikan', 'Pertanyaan 3 - Dampak Signifikan')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Ya, memberikan dampak yang signifikan <i
                                                        class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                            ...
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-success" role="progressbar"
                                                    style="width: <?= $pct_q3_sig ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger"
                                            onclick="showRespondents('q3', 'cukup_dampak', 'Pertanyaan 3 - Cukup Memberikan Dampak')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Ya, cukup memberikan dampak <i class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q3_cukup_dampak ?> (<?= $pct_q3_cuk ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-primary" role="progressbar"
                                                    style="width: <?= $pct_q3_cuk ?>%"></div>
                                            </div>
                                        </div>
                                        <div class="respondent-trigger" style="margin-bottom:0;"
                                            onclick="showRespondents('q3', 'kurang_dampak', 'Pertanyaan 3 - Kurang Memberikan Dampak')">
                                            <div class="d-flex justify-content-between mb-1" style="font-size: 0.85rem;">
                                                <span>Kurang memberikan dampak nyata <i class="fas fa-eye text-primary ms-1"
                                                        style="font-size: 0.75rem; opacity: 0.7;"></i></span>
                                                <span class="fw-bold"><?= $q3_kurang_dampak ?> (<?= $pct_q3_kur ?>%)</span>
                                            </div>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar bg-danger" role="progressbar"
                                                    style="width: <?= $pct_q3_kur ?>%"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="p-3 rounded bg-white bg-opacity-50 border border-white overflow-auto"
                                    ...
                                    <?php foreach ($saran_list as $saran): ?>
                                        <div class="mb-3 pb-3 border-bottom last-border-none">
                                            ...
                                            <div class="text-muted mb-2" style="font-size: 0.75rem;">
                                                Kegiatan: <span
                                                    class="text-secondary"><?= htmlspecialchars($saran['kegiatan']) ?></span>
                                                | Oleh: <span class="text-secondary"><?= htmlspecialchars($saran['pemberi']) ?></span>
                                            </div>
                                            <div class="p-2 rounded bg-white bg-opacity-70 border"
                                                style="font-size: 0.85rem; font-style: italic; color: #495057;">
    ...
    <div class="modal fade" id="respondentsModal" tabindex="-1" aria-labelledby="respondentsModalLabel"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <span class="text-muted d-block"
                            style="font-size:0.8rem; text-transform:uppercase; font-weight:600; letter-spacing:0.5px;">Kategori
                            Jawaban</span>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        style="background: rgba(0,0,0,0.05); border: 1px solid var(--border); color: var(--text-muted); font-weight: 600; border-radius: 8px;">Tutup</button>
                </div>
            </div>
        </div>
    </div>
