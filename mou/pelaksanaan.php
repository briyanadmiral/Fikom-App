        ...
        <div class="card-body p-0">
          ...
          <tbody class="text-center">
            <?php $no = $offset + 1; while ($row = mysqli_fetch_assoc($result)):
              ...
              $count_internal = mysqli_fetch_assoc(mysqli_query($conn, "SELECT COUNT(*) AS total FROM evaluasi_internal WHERE id_pelaksanaan = $id_pelaksanaan AND deleted_at IS NULL"))['total'];
