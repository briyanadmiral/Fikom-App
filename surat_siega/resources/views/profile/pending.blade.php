...
<head>
    ...
    <title>Menunggu Verifikasi - FIKOM UNIKA Soegijapranata</title>
...
<div class="container">
    <div class="card">
        <div class="header">
            ...
            <div class="subtitle">Verifikasi Pendaftaran</div>
        </div>
        ...
        <div class="success-box">
            ...
            <div>
                ...
                Please wait for TU verification before logging in.
            </div>
        </div>
        ...
        <div class="summary-list">
            ...
            <div class="summary-item">
                ...
                <span class="summary-val">{{ $user->whatsapp }}</span>
            </div>
