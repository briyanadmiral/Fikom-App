{{-- resources/views/surat_keputusan/download_form.blade.php --}}
@extends('layouts.app')
@section('title', 'Download PDF SK: ' . ($sk->nomor ?? 'Tanpa Nomor'))

@section('content')
@php
    $friendlyName = 'SuratKeputusan_' . (preg_replace('/[^a-zA-Z0-9_-]/', '_', $sk->nomor) ?? 'TanpaNomor') . '.pdf';
    $downloadUrl = route('surat_keputusan.downloadPdf', [$sk->id, $friendlyName]);
@endphp
        ...
        <div class="col-lg-9 col-xl-10">
                    ...
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            ...
                            <p class="mb-0 small text-dark">
                                Surat keputusan ini telah ditimpa dengan file PDF bertanda tangan/cap hasil import. 
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white py-2 d-flex justify-content-between align-items-center">
                    <span class="small font-weight-bold"><i class="fas fa-file-alt mr-1 text-primary"></i>Pratinjau Surat Keputusan</span>
                    @if (!$showSigns)
                ...
                <div class="card-body p-2 bg-light" style="overflow-x:auto">
                    ...
                    @endif
                    <div id="htmlPreview" @if ($sk->signed_pdf_path) style="display: none;" @endif>
                        @include('surat_keputusan.partials._core', [
                            'context' => 'web',
                            'keputusan' => $sk,
                            'kop' => $kop ?? null,
                            'ttdW' => $sk->ttd_w_mm ?? ($ttdW ?? 42),
                            'capW' => $sk->cap_w_mm ?? ($capW ?? 35),
                            'capOpacity' => $sk->cap_opacity ?? ($capOpacity ?? 0.95),
...
<script>
    document.getElementById('btnDownloadPdf').addEventListener('click', function() {
        ...
        var hasImported = @json(!empty($sk->signed_pdf_path));
