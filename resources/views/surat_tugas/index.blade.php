...
<style>
  ...
  /* Hover effects */
  .dropdown-item.text-info:hover { background-color: #17a2b8 !important; color: white !important; }
  .dropdown-item.text-warning:hover { background-color: #ffc107 !important; color: #212529 !important; }
  .dropdown-item.text-success:hover { background-color: #28a745 !important; color: white !important; }
  .dropdown-item.text-danger:hover { background-color: #dc3545 !important; color: white !important; }
  .dropdown-item.text-primary:hover { background-color: #007bff !important; color: white !important; }
  .dropdown-item.text-purple:hover { background-color: #6f42c1 !important; color: white !important; }
  
  .dropdown-item.text-warning:hover i { color: #212529 !important; }
  .dropdown-item:hover i { color: inherit !important; }
  
  .badge-pill{padding:0.45rem 0.85rem;font-size:0.85rem;font-weight:600;letter-spacing:0.3px}
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                @php
                  $badgeMap = [
                    'draft'=>'secondary','pending'=>'warning','disetujui'=>'success','ditolak'=>'danger'
                  ];
...
<td class="text-center">
  <div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
      ...
      {{-- 2. Detail Page --}}
      <a class="dropdown-item text-info" href="{{ route('surat_tugas.show', $h->id) }}">
      ...
      @if($h->status_surat === 'pending' && (int) $h->next_approver === (int) auth()->id())
        <a class="dropdown-item text-success" href="{{ route('surat_tugas.approveForm', $h->id) }}">
