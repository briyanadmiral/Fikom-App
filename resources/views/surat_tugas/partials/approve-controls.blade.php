...
<div class="row g-3">
  <div class="col-md-4">
    ...
    <input
      ...
      required
    >
    @error('ttd_w_mm')<div class="invalid-feedback">{{ $message }}</div>@enderror
  ...
  <div class="col-md-4">
    ...
    <input
      ...
      required
    >
    @error('cap_w_mm')<div class="invalid-feedback">{{ $message }}</div>@enderror
  ...
  <div class="col-md-4">
    ...
    <input
      ...
      required
    >
    @error('cap_opacity')<div class="invalid-feedback">{{ $message }}</div>@enderror
