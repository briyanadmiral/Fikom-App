    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="tab-dasar" role="tabpanel">
                            ...
                            {{-- NOMOR SURAT (dua mode) --}}
                            <div class="form-group">
                                <label>Nomor Surat</label>
                                <div class="row align-items-center">
                                    <div class="col-md-5">
                                        <label class="small text-muted">Kode</label>
                                    ...
                                    <div class="col-md-2">
                                        <label class="small text-muted">Thn</label>
                            ...
                            <div class="form-group mt-2">
                                ...
                                <div class="input-group">
                                    <input type="text" id="nomor_surat_lengkap_display" class="form-control"
                                        style="background:#e9ecef;cursor:not-allowed;font-weight:bold;letter-spacing:1px"
                                        value="..." readonly>
                                ...
                                <small class="form-text text-muted">
                                    ...
                                    @else
                                        Klik ↻ untuk menyiapkan nomor urut berikutnya dari server. Isi "Nomor Surat
                                        Manual" untuk override.
                                    @endif
                                </small>
                            ...
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">Jika diisi, nomor otomatis akan diabaikan.</small>
                            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card card-info card-outline position-sticky" style="top:80px">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="penandatangan_id">Pilih Penandatangan</label>
