...
<div class="page-header mt-2 mb-3">
    ...
    <span>
        ...
        <div class="page-header-desc">Tinjau, atur tata letak TTD/Cap, dan setujui surat <b>{{ $tugas->nomor }}</b>.</div>
    </span>
</div>
@endsection
        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                ...
                <div class="card card-control mb-4">
                    <div class="card-header"><h6 class="mb-0 font-weight-bold"><i class="fas fa-info-circle mr-2 text-primary"></i>Informasi Surat</h6></div>
                    <div class="card-body">
                        <dl class="row mb-0">
                            <dt class="col-sm-4">Nomor</dt><dd class="col-sm-8">{{ $tugas->nomor }}</dd>
                            <dt class="col-sm-4">Perihal</dt><dd class="col-sm-8">{{ $tugas->nama_umum }}</dd>
                            <dt class="col-sm-4">Pembuat</dt><dd class="col-sm-8">{{ optional($tugas->pembuat)->nama_lengkap ?? 'N/A' }}</dd>
                        </dl>
                    </div>
                </div>
                ...
                <div class="card card-control">
                    <div class="card-header"><h6 class="mb-0 font-weight-bold"><i class="fas fa-sliders-h mr-2 text-success"></i>Panel Persetujuan</h6></div>
                    <div class="card-body">
            ...
            <div class="col-lg-8">
                <div class="card card-preview">
                    <div class="card-header"><h6 class="mb-0 font-weight-bold"><i class="fas fa-file-alt mr-2"></i>Pratinjau Dokumen Final</h6></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const urlBase = "{{ route('surat_tugas.show', $tugas->id) }}"; // Menggunakan route show dengan flag partial
