...
<style>
    ...
    .surat-header .icon {
        ...
        border-radius: 50%;
        box-shadow: 0 1px 10px rgba(23,162,184,0.3);
        font-size: 1.8rem
    }
    .surat-header-title {
        font-weight: bold;
...
@section('content_header')
    <div class="surat-header mt-2">
        ...
        <div>
            <div class="surat-header-title">Library Mengingat (Dasar Hukum)</div>
            <div class="surat-header-desc">Kelola referensi <b>dasar hukum</b> yang digunakan dalam Surat Keputusan.</div>
        </div>
    </div>
@endsection
    ...
    <div class="card">
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <form method="GET" action="{{ route('mengingat_library.index') }}" class="form-inline">
                        <div class="input-group input-group-sm mr-2">
                            <input type="text" name="search" class="form-control" placeholder="Cari nomor/judul..." value="{{ request('search') }}">
                ...
                <div class="col-md-6 text-right">
                    <a href="{{ route('mengingat_library.create') }}" class="btn btn-primary btn-sm">
