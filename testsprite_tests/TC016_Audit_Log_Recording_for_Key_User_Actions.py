...
async def run_test():
    ...
    try:
        ...
        # -> Log in using provided credentials (input email, input password, submit).
        ...
        # -> Open the Audit Log interface by clicking the Audit Log sidebar link (element index 454).
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=html/body/div[2]/aside[1]/div/nav/ul/li[13]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
